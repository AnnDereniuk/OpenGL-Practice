...
//
//	
////	glTranslatef(0.0, 0.0, -5.0);// traslate the draw by z = -4.0
//	// Note this when you decrease z like -8.0 the drawing will looks far , or smaller.
//	glColor3f(0.9, 0.3, 0.2);	// Red color used to draw.
//
//	// changing in transformation matrix.
//	// rotation about X axis
//	
//	glutWireSphere(0.3, 20, 20);	// built-in (glut library) function , draw you a sphere.
//
